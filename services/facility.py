...
app.config['SQLALCHEMY_DATABASE_URI'] = environ.get('facilityURL') or 'mysql+mysqlconnector://admin:esdg1t32021@esd-prod.ckcprxmpwut9.us-east-1.rds.amazonaws.com:3306/facility'
